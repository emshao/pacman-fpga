...
#create_clock -period 30.000 -name sys_clk_pin -waveform {0.000 15.000} -add [get_ports clk_33mhz]
create_clock -period 30.000 -name sys_clk_pin -waveform {0.000 17.500} -add [get_ports clk_33mhz]
